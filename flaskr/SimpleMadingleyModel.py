...
import matplotlib.plot as mplib.plot
...
mplib.pyplot.subplot(4,1,1)
mplib.pyplot.plot(range(12),np.log10(hb[:,0:100]))
mplib.pyplot.subplot(4,1,2)
mplib.pyplot.plot(range(12),np.log10(cb[:,0:100]))
mplib.pyplot.subplot(4,1,3)
mplib.pyplot.plot(range(12),np.log10(ppb[:,0:100]))
mplib.pyplot.subplot(4,1,4)
mplib.pyplot.plot(range(12),np.log10(harvest[:,0:100]))
mplib.pyplot.show()

#Plotting the harvest effort
mplib.pyplot.hist(heff)

#Checking size structure
mplib.pyplot.subplot(2,1,1)
mplib.pyplot.plot(bodymasses,np.log10(herbivore_biomasses[0]))
mplib.pyplot.subplot(2,1,2)
mplib.pyplot.plot(bodymasses,np.log10(carnivore_biomasses[0]))
mplib.pyplot.show()
